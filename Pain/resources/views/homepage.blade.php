<!DOCTYPE html>
<html xmlns:th="http://www.thymeleaf.org/%22%3E"></html>
<head>
    <meta charset="utf-8">
...
<div class="content">
    <div class="conteiner">
        ...
        <p class="content_p">«Lotus» - это сообщество, которое обсуждает мировые теории заговоров.r <br>
            У нас ты найдешь самые невероятные теории создания планеты Земля, <br>
            а так же самых влиятельных людей в галактике. <br>
            Мы поможем вам познать бессметрие, а так же почуствовать дыхание жизни... <br>
